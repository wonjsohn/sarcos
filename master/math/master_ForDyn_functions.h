...
a2[1]=state[2].thd*v2[2];
a2[2]=-(state[2].thd*v2[1]);
a2[4]=a1[4]*S21[1][1] + a1[6]*S21[1][3];
a2[5]=a1[4]*S21[2][1] + a1[6]*S21[2][3];
a2[6]=a1[5];

a3[1]=state[3].thd*v3[2] + a2[2]*S32[1][2];
a3[2]=-(state[3].thd*v3[1]) + a2[2]*S32[2][2];
a3[3]=a2[1];
...
fnet2[1]=links[2].m*a2[4] + a2[2]*links[2].mcm[3] - links[2].mcm[1]*Power(v2[2],2) - links[2].mcm[1]*Power(v2[3],2) + v2[1]*(links[2].mcm[2]*v2[2] + links[2].mcm[3]*v2[3]);
fnet2[2]=links[2].m*a2[5] - a2[1]*links[2].mcm[3] - links[2].mcm[2]*Power(v2[1],2) - links[2].mcm[2]*Power(v2[3],2) + v2[2]*(links[2].mcm[1]*v2[1] + links[2].mcm[3]*v2[3]);
...
fnet2[4]=a2[6]*links[2].mcm[2] - a2[5]*links[2].mcm[3] + a2[1]*links[2].inertia[1][1] + a2[2]*links[2].inertia[1][2] + v2[1]*(-(v2[3]*links[2].inertia[1][2]) + v2[2]*links[2].inertia[1][3]) + v2[2]*(-(v2[3]*links[2].inertia[2][2]) + v2[2]*links[2].inertia[2][3]) + v2[3]*(-(v2[3]*links[2].inertia[2][3]) + v2[2]*links[2].inertia[3][3]);
fnet2[5]=-(a2[6]*links[2].mcm[1]) + a2[4]*links[2].mcm[3] + a2[1]*links[2].inertia[1][2] + v2[1]*(v2[3]*links[2].inertia[1][1] - v2[1]*links[2].inertia[1][3]) + a2[2]*links[2].inertia[2][2] + v2[2]*(v2[3]*links[2].inertia[1][2] - v2[1]*links[2].inertia[2][3]) + v2[3]*(v2[3]*links[2].inertia[1][3] - v2[1]*links[2].inertia[3][3]);
fnet2[6]=a2[5]*links[2].mcm[1] - a2[4]*links[2].mcm[2] + v2[1]*(-(v2[2]*links[2].inertia[1][1]) + v2[1]*links[2].inertia[1][2]) + a2[1]*links[2].inertia[1][3] + v2[2]*(-(v2[2]*links[2].inertia[1][2]) + v2[1]*links[2].inertia[2][2]) + a2[2]*links[2].inertia[2][3] + v2[3]*(-(v2[2]*links[2].inertia[1][3]) + v2[1]*links[2].inertia[2][3]);
...
fex1[3]=-0.7071067811865475*uex[1].f[1] - 0.7071067811865475*uex[1].f[3];
...
fex1[6]=-0.7071067811865475*uex[1].t[1] - 0.7071067811865475*uex[1].t[3];
...
Jcc0[1][2]=S10[1][2]*(0.7071067811865475*Jc1[3][1] + Jc1[1][1]*Si01[1][1] + Jc1[2][1]*Si01[1][2]) + S10[2][2]*(0.7071067811865475*Jc1[3][2] + Jc1[1][2]*Si01[1][1] + Jc1[2][2]*Si01[1][2]) + ((l0*S10[1][1])/Sqrt(2) - (l0*S10[1][3])/Sqrt(2))*(0.7071067811865475*Jc1[3][4] + Jc1[1][4]*Si01[1][1] + Jc1[2][4]*Si01[1][2]) + ((l0*S10[2][1])/Sqrt(2) - (l0*S10[2][3])/Sqrt(2))*(0.7071067811865475*Jc1[3][5] + Jc1[1][5]*Si01[1][1] + Jc1[2][5]*Si01[1][2]);
Jcc0[1][3]=S10[1][3]*(0.7071067811865475*Jc1[3][1] + Jc1[1][1]*Si01[1][1] + Jc1[2][1]*Si01[1][2]) + S10[2][3]*(0.7071067811865475*Jc1[3][2] + Jc1[1][2]*Si01[1][1] + Jc1[2][2]*Si01[1][2]) + 0.7071067811865475*(0.7071067811865475*Jc1[3][3] + Jc1[1][3]*Si01[1][1] + Jc1[2][3]*Si01[1][2]) + (l0*S10[1][2]*(0.7071067811865475*Jc1[3][4] + Jc1[1][4]*Si01[1][1] + Jc1[2][4]*Si01[1][2]))/Sqrt(2) + (l0*S10[2][2]*(0.7071067811865475*Jc1[3][5] + Jc1[1][5]*Si01[1][1] + Jc1[2][5]*Si01[1][2]))/Sqrt(2);
Jcc0[1][4]=S10[1][1]*(0.7071067811865475*Jc1[3][4] + Jc1[1][4]*Si01[1][1] + Jc1[2][4]*Si01[1][2]) + S10[2][1]*(0.7071067811865475*Jc1[3][5] + Jc1[1][5]*Si01[1][1] + Jc1[2][5]*Si01[1][2]) + 0.7071067811865475*(0.7071067811865475*Jc1[3][6] + Jc1[1][6]*Si01[1][1] + Jc1[2][6]*Si01[1][2]);
...
Jcc0[2][1]=S10[1][1]*(Jc1[1][1]*Si01[2][1] + Jc1[2][1]*Si01[2][2]) + S10[2][1]*(Jc1[1][2]*Si01[2][1] + Jc1[2][2]*Si01[2][2]) + 0.7071067811865475*(Jc1[1][3]*Si01[2][1] + Jc1[2][3]*Si01[2][2]) - (l0*S10[1][2]*(Jc1[1][4]*Si01[2][1] + Jc1[2][4]*Si01[2][2]))/Sqrt(2) - (l0*S10[2][2]*(Jc1[1][5]*Si01[2][1] + Jc1[2][5]*Si01[2][2]))/Sqrt(2);
...
Jcc0[2][3]=S10[1][3]*(Jc1[1][1]*Si01[2][1] + Jc1[2][1]*Si01[2][2]) + S10[2][3]*(Jc1[1][2]*Si01[2][1] + Jc1[2][2]*Si01[2][2]) + 0.7071067811865475*(Jc1[1][3]*Si01[2][1] + Jc1[2][3]*Si01[2][2]) + (l0*S10[1][2]*(Jc1[1][4]*Si01[2][1] + Jc1[2][4]*Si01[2][2]))/Sqrt(2) + (l0*S10[2][2]*(Jc1[1][5]*Si01[2][1] + Jc1[2][5]*Si01[2][2]))/Sqrt(2);
...
Jcc0[3][1]=S10[1][1]*(0.7071067811865475*Jc1[3][1] + Jc1[1][1]*Si01[3][1] + Jc1[2][1]*Si01[3][2]) + S10[2][1]*(0.7071067811865475*Jc1[3][2] + Jc1[1][2]*Si01[3][1] + Jc1[2][2]*Si01[3][2]) + 0.7071067811865475*(0.7071067811865475*Jc1[3][3] + Jc1[1][3]*Si01[3][1] + Jc1[2][3]*Si01[3][2]) - (l0*S10[1][2]*(0.7071067811865475*Jc1[3][4] + Jc1[1][4]*Si01[3][1] + Jc1[2][4]*Si01[3][2]))/Sqrt(2) - (l0*S10[2][2]*(0.7071067811865475*Jc1[3][5] + Jc1[1][5]*Si01[3][1] + Jc1[2][5]*Si01[3][2]))/Sqrt(2);
Jcc0[3][2]=S10[1][2]*(0.7071067811865475*Jc1[3][1] + Jc1[1][1]*Si01[3][1] + Jc1[2][1]*Si01[3][2]) + S10[2][2]*(0.7071067811865475*Jc1[3][2] + Jc1[1][2]*Si01[3][1] + Jc1[2][2]*Si01[3][2]) + ((l0*S10[1][1])/Sqrt(2) - (l0*S10[1][3])/Sqrt(2))*(0.7071067811865475*Jc1[3][4] + Jc1[1][4]*Si01[3][1] + Jc1[2][4]*Si01[3][2]) + ((l0*S10[2][1])/Sqrt(2) - (l0*S10[2][3])/Sqrt(2))*(0.7071067811865475*Jc1[3][5] + Jc1[1][5]*Si01[3][1] + Jc1[2][5]*Si01[3][2]);
...
K[1][1]=0.7071067811865475*Fu11[3] + Fu11[1]*Si01[1][1] + Fu11[2]*Si01[1][2];
K[1][2]=Fu11[1]*Si01[2][1] + Fu11[2]*Si01[2][2];
K[1][3]=0.7071067811865475*Fu11[3] + Fu11[1]*Si01[3][1] + Fu11[2]*Si01[3][2];
K[1][4]=0.7071067811865475*Fu11[6] + Fu11[4]*Si01[1][1] + Fu11[5]*Si01[1][2] - (l0*Fu11[1]*Si01[2][1])/Sqrt(2) - (l0*Fu11[2]*Si01[2][2])/Sqrt(2);
K[1][5]=Fu11[4]*Si01[2][1] + Fu11[5]*Si01[2][2] + Fu11[1]*((l0*Si01[1][1])/Sqrt(2) - (l0*Si01[3][1])/Sqrt(2)) + Fu11[2]*((l0*Si01[1][2])/Sqrt(2) - (l0*Si01[3][2])/Sqrt(2));
K[1][6]=0.7071067811865475*Fu11[6] + (l0*Fu11[1]*Si01[2][1])/Sqrt(2) + (l0*Fu11[2]*Si01[2][2])/Sqrt(2) + Fu11[4]*Si01[3][1] + Fu11[5]*Si01[3][2];

K[2][1]=0.7071067811865475*Fu21[3] + Fu21[1]*Si01[1][1] + Fu21[2]*Si01[1][2];
K[2][2]=Fu21[1]*Si01[2][1] + Fu21[2]*Si01[2][2];
K[2][3]=0.7071067811865475*Fu21[3] + Fu21[1]*Si01[3][1] + Fu21[2]*Si01[3][2];
K[2][4]=0.7071067811865475*Fu21[6] + Fu21[4]*Si01[1][1] + Fu21[5]*Si01[1][2] - (l0*Fu21[1]*Si01[2][1])/Sqrt(2) - (l0*Fu21[2]*Si01[2][2])/Sqrt(2);
K[2][5]=Fu21[4]*Si01[2][1] + Fu21[5]*Si01[2][2] + Fu21[1]*((l0*Si01[1][1])/Sqrt(2) - (l0*Si01[3][1])/Sqrt(2)) + Fu21[2]*((l0*Si01[1][2])/Sqrt(2) - (l0*Si01[3][2])/Sqrt(2));
K[2][6]=0.7071067811865475*Fu21[6] + (l0*Fu21[1]*Si01[2][1])/Sqrt(2) + (l0*Fu21[2]*Si01[2][2])/Sqrt(2) + Fu21[4]*Si01[3][1] + Fu21[5]*Si01[3][2];

K[3][1]=0.7071067811865475*Fu31[3] + Fu31[1]*Si01[1][1] + Fu31[2]*Si01[1][2];
K[3][2]=Fu31[1]*Si01[2][1] + Fu31[2]*Si01[2][2];
K[3][3]=0.7071067811865475*Fu31[3] + Fu31[1]*Si01[3][1] + Fu31[2]*Si01[3][2];
K[3][4]=0.7071067811865475*Fu31[6] + Fu31[4]*Si01[1][1] + Fu31[5]*Si01[1][2] - (l0*Fu31[1]*Si01[2][1])/Sqrt(2) - (l0*Fu31[2]*Si01[2][2])/Sqrt(2);
K[3][5]=Fu31[4]*Si01[2][1] + Fu31[5]*Si01[2][2] + Fu31[1]*((l0*Si01[1][1])/Sqrt(2) - (l0*Si01[3][1])/Sqrt(2)) + Fu31[2]*((l0*Si01[1][2])/Sqrt(2) - (l0*Si01[3][2])/Sqrt(2));
K[3][6]=0.7071067811865475*Fu31[6] + (l0*Fu31[1]*Si01[2][1])/Sqrt(2) + (l0*Fu31[2]*Si01[2][2])/Sqrt(2) + Fu31[4]*Si01[3][1] + Fu31[5]*Si01[3][2];

K[4][1]=0.7071067811865475*Fu41[3] + Fu41[1]*Si01[1][1] + Fu41[2]*Si01[1][2];
K[4][2]=Fu41[1]*Si01[2][1] + Fu41[2]*Si01[2][2];
K[4][3]=0.7071067811865475*Fu41[3] + Fu41[1]*Si01[3][1] + Fu41[2]*Si01[3][2];
K[4][4]=0.7071067811865475*Fu41[6] + Fu41[4]*Si01[1][1] + Fu41[5]*Si01[1][2] - (l0*Fu41[1]*Si01[2][1])/Sqrt(2) - (l0*Fu41[2]*Si01[2][2])/Sqrt(2);
K[4][5]=Fu41[4]*Si01[2][1] + Fu41[5]*Si01[2][2] + Fu41[1]*((l0*Si01[1][1])/Sqrt(2) - (l0*Si01[3][1])/Sqrt(2)) + Fu41[2]*((l0*Si01[1][2])/Sqrt(2) - (l0*Si01[3][2])/Sqrt(2));
K[4][6]=0.7071067811865475*Fu41[6] + (l0*Fu41[1]*Si01[2][1])/Sqrt(2) + (l0*Fu41[2]*Si01[2][2])/Sqrt(2) + Fu41[4]*Si01[3][1] + Fu41[5]*Si01[3][2];

K[5][1]=0.7071067811865475*Fu51[3] + Fu51[1]*Si01[1][1] + Fu51[2]*Si01[1][2];
K[5][2]=Fu51[1]*Si01[2][1] + Fu51[2]*Si01[2][2];
K[5][3]=0.7071067811865475*Fu51[3] + Fu51[1]*Si01[3][1] + Fu51[2]*Si01[3][2];
K[5][4]=0.7071067811865475*Fu51[6] + Fu51[4]*Si01[1][1] + Fu51[5]*Si01[1][2] - (l0*Fu51[1]*Si01[2][1])/Sqrt(2) - (l0*Fu51[2]*Si01[2][2])/Sqrt(2);
K[5][5]=Fu51[4]*Si01[2][1] + Fu51[5]*Si01[2][2] + Fu51[1]*((l0*Si01[1][1])/Sqrt(2) - (l0*Si01[3][1])/Sqrt(2)) + Fu51[2]*((l0*Si01[1][2])/Sqrt(2) - (l0*Si01[3][2])/Sqrt(2));
K[5][6]=0.7071067811865475*Fu51[6] + (l0*Fu51[1]*Si01[2][1])/Sqrt(2) + (l0*Fu51[2]*Si01[2][2])/Sqrt(2) + Fu51[4]*Si01[3][1] + Fu51[5]*Si01[3][2];

K[6][1]=0.7071067811865475*Fu61[3] + Fu61[1]*Si01[1][1] + Fu61[2]*Si01[1][2];
K[6][2]=Fu61[1]*Si01[2][1] + Fu61[2]*Si01[2][2];
K[6][3]=0.7071067811865475*Fu61[3] + Fu61[1]*Si01[3][1] + Fu61[2]*Si01[3][2];
K[6][4]=0.7071067811865475*Fu61[6] + Fu61[4]*Si01[1][1] + Fu61[5]*Si01[1][2] - (l0*Fu61[1]*Si01[2][1])/Sqrt(2) - (l0*Fu61[2]*Si01[2][2])/Sqrt(2);
K[6][5]=Fu61[4]*Si01[2][1] + Fu61[5]*Si01[2][2] + Fu61[1]*((l0*Si01[1][1])/Sqrt(2) - (l0*Si01[3][1])/Sqrt(2)) + Fu61[2]*((l0*Si01[1][2])/Sqrt(2) - (l0*Si01[3][2])/Sqrt(2));
K[6][6]=0.7071067811865475*Fu61[6] + (l0*Fu61[1]*Si01[2][1])/Sqrt(2) + (l0*Fu61[2]*Si01[2][2])/Sqrt(2) + Fu61[4]*Si01[3][1] + Fu61[5]*Si01[3][2];

K[7][1]=0.7071067811865475*Fu71[3] + Fu71[1]*Si01[1][1] + Fu71[2]*Si01[1][2];
K[7][2]=Fu71[1]*Si01[2][1] + Fu71[2]*Si01[2][2];
K[7][3]=0.7071067811865475*Fu71[3] + Fu71[1]*Si01[3][1] + Fu71[2]*Si01[3][2];
K[7][4]=0.7071067811865475*Fu71[6] + Fu71[4]*Si01[1][1] + Fu71[5]*Si01[1][2] - (l0*Fu71[1]*Si01[2][1])/Sqrt(2) - (l0*Fu71[2]*Si01[2][2])/Sqrt(2);
K[7][5]=Fu71[4]*Si01[2][1] + Fu71[5]*Si01[2][2] + Fu71[1]*((l0*Si01[1][1])/Sqrt(2) - (l0*Si01[3][1])/Sqrt(2)) + Fu71[2]*((l0*Si01[1][2])/Sqrt(2) - (l0*Si01[3][2])/Sqrt(2));
K[7][6]=0.7071067811865475*Fu71[6] + (l0*Fu71[1]*Si01[2][1])/Sqrt(2) + (l0*Fu71[2]*Si01[2][2])/Sqrt(2) + Fu71[4]*Si01[3][1] + Fu71[5]*Si01[3][2];

K[9][1]=0.7071067811865475*Fu91[3] + Fu91[1]*Si01[1][1] + Fu91[2]*Si01[1][2];
K[9][2]=Fu91[1]*Si01[2][1] + Fu91[2]*Si01[2][2];
K[9][3]=0.7071067811865475*Fu91[3] + Fu91[1]*Si01[3][1] + Fu91[2]*Si01[3][2];
K[9][4]=0.7071067811865475*Fu91[6] + Fu91[4]*Si01[1][1] + Fu91[5]*Si01[1][2] - (l0*Fu91[1]*Si01[2][1])/Sqrt(2) - (l0*Fu91[2]*Si01[2][2])/Sqrt(2);
K[9][5]=Fu91[4]*Si01[2][1] + Fu91[5]*Si01[2][2] + Fu91[1]*((l0*Si01[1][1])/Sqrt(2) - (l0*Si01[3][1])/Sqrt(2)) + Fu91[2]*((l0*Si01[1][2])/Sqrt(2) - (l0*Si01[3][2])/Sqrt(2));
K[9][6]=0.7071067811865475*Fu91[6] + (l0*Fu91[1]*Si01[2][1])/Sqrt(2) + (l0*Fu91[2]*Si01[2][2])/Sqrt(2) + Fu91[4]*Si01[3][1] + Fu91[5]*Si01[3][2];

K[10][1]=0.7071067811865475*Fu101[3] + Fu101[1]*Si01[1][1] + Fu101[2]*Si01[1][2];
K[10][2]=Fu101[1]*Si01[2][1] + Fu101[2]*Si01[2][2];
K[10][3]=0.7071067811865475*Fu101[3] + Fu101[1]*Si01[3][1] + Fu101[2]*Si01[3][2];
K[10][4]=0.7071067811865475*Fu101[6] + Fu101[4]*Si01[1][1] + Fu101[5]*Si01[1][2] - (l0*Fu101[1]*Si01[2][1])/Sqrt(2) - (l0*Fu101[2]*Si01[2][2])/Sqrt(2);
K[10][5]=Fu101[4]*Si01[2][1] + Fu101[5]*Si01[2][2] + Fu101[1]*((l0*Si01[1][1])/Sqrt(2) - (l0*Si01[3][1])/Sqrt(2)) + Fu101[2]*((l0*Si01[1][2])/Sqrt(2) - (l0*Si01[3][2])/Sqrt(2));
K[10][6]=0.7071067811865475*Fu101[6] + (l0*Fu101[1]*Si01[2][1])/Sqrt(2) + (l0*Fu101[2]*Si01[2][2])/Sqrt(2) + Fu101[4]*Si01[3][1] + Fu101[5]*Si01[3][2];

K[12][1]=0.7071067811865475*Fu121[3] + Fu121[1]*Si01[1][1] + Fu121[2]*Si01[1][2];
K[12][2]=Fu121[1]*Si01[2][1] + Fu121[2]*Si01[2][2];
K[12][3]=0.7071067811865475*Fu121[3] + Fu121[1]*Si01[3][1] + Fu121[2]*Si01[3][2];
K[12][4]=0.7071067811865475*Fu121[6] + Fu121[4]*Si01[1][1] + Fu121[5]*Si01[1][2] - (l0*Fu121[1]*Si01[2][1])/Sqrt(2) - (l0*Fu121[2]*Si01[2][2])/Sqrt(2);
K[12][5]=Fu121[4]*Si01[2][1] + Fu121[5]*Si01[2][2] + Fu121[1]*((l0*Si01[1][1])/Sqrt(2) - (l0*Si01[3][1])/Sqrt(2)) + Fu121[2]*((l0*Si01[1][2])/Sqrt(2) - (l0*Si01[3][2])/Sqrt(2));
K[12][6]=0.7071067811865475*Fu121[6] + (l0*Fu121[1]*Si01[2][1])/Sqrt(2) + (l0*Fu121[2]*Si01[2][2])/Sqrt(2) + Fu121[4]*Si01[3][1] + Fu121[5]*Si01[3][2];
