...
/* global functions */
void				add_dragging_PD_gravity_compensation_task(void);

/* local functions */
static int 			init_dragging_PD_gravity_compensation_task(void);
static int			run_dragging_PD_gravity_compensation_task(void);
static SL_DJstate	extra_joint_state_filter(int);
static int			change_dragging_PD_gravity_compensation_task(void);


/*****************************************************************************
******************************************************************************
Function Name	: add_dragging_PD_gravity_compensation_task
Date			: Feb 1999
Remarks:
...
*****************************************************************************/
void
add_dragging_PD_gravity_compensation_task( void )
{
	int i, j;

	addTask("Dragging PD Gravity Compensation Task", init_dragging_PD_gravity_compensation_task,
			run_dragging_PD_gravity_compensation_task, change_dragging_PD_gravity_compensation_task);
}

/*****************************************************************************
******************************************************************************
  Function Name	: init_dragging_PD_gravity_compensation_task
  Date			: January 2015
 ...
 *****************************************************************************/
static int 
init_dragging_PD_gravity_compensation_task(void)
{
	int j, i;
	int ans;
...
/*****************************************************************************
******************************************************************************
  Function Name	: run_dragging_PD_gravity_compensation_task
  Date			: January 2015
 ...
 *****************************************************************************/
static int 
run_dragging_PD_gravity_compensation_task(void)
{
	int 	i;
	double	tau;
...
/*****************************************************************************
******************************************************************************
  Function Name	: change_dragging_PD_gravity_compensation_task
  Date			: January 2015
 ...
 *****************************************************************************/
static int
change_dragging_PD_gravity_compensation_task(void)
{
	double	aux;
	int		aux_int;
