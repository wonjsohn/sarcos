...
if __name__ == "__main__":
    ...
    nerfModel = FpgaDevice("12430003T2",  BIT_FILE_LIST[0])
    print "serial = 12430003T2  \n"
    nerfModel.onClkRate(sim_speed) # 1x realtime
    xemList.append(nerfModel)
    nerfModel = FpgaDevice("11160001CJ",  BIT_FILE_LIST[1])  # transcortical part
    print "serial = 11160001CJ : transcortical \n"
    nerfModel.onClkRate(sim_speed) # 1x realtime
    xemList.append(nerfModel)
    
    nerfModel = FpgaDevice("0000000550",  BIT_FILE_LIST[0])
    print "serial = 0000000550  \n"
    nerfModel.onClkRate(sim_speed) # 1x realtime
    xemList.append(nerfModel)
    nerfModel = FpgaDevice("000000053X",  BIT_FILE_LIST[1])  # transcortical part
    print "serial = 000000053X : transcortical  \n"
    nerfModel.onClkRate(sim_speed) # 1x realtime
    xemList.append(nerfModel)
