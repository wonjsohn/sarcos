...
ROBOT2FPGA_FILENAME = '/Network/Servers/duerer/guest/prog/masterUser/src/robot2fpga.dat'
...
class Robot:
    ...
    def write(self, num):    # write to robot
        self.fpga2robot_map.seek(0)    # simple test of validityCONFIG_XENO_OPT_WATCHDOG_TIMEOUT=4
    ...
    def read(self):  # read from robot
        ...
        self.robot2fpga_map.seek(0)    # simple test of validity
        dataOut = self.robot2fpga_map.readline()
...
if __name__ == "__main__":
    ...
    BIT_FILE = "/Network/Servers/duerer/guest/prog/masterUser/src/one_joint_robot_xem6010.bit"
    BIT_FILE2 = "/Network/Servers/duerer/guest/prog/masterUser/src/one_joint_robot_xem6010.bit"
    ...
    while (1):     
        ...
        currentAngle = shaal.read()    # read from robot

        #print "python reporting Angle: %f " % currentAngle
